...
const Calculator2 = () => {
  ...
  const calculateResult = () => {
    ...
    const leftOperand = parseFloat(input.substring(0, operatorIndex));
    const rightOperand = parseFloat(input.substring(operatorIndex + 1));
    ...
    switch (operator) {
      ...
      case "*":
        ...
        break;
      case "/":
        calculation = rightOperand !== 0 ? leftOperand / rightOperand : "Error";
        break;
      default:
        break;
    }
  ...
  return (
    <div style={containerStyle}>
      ...
      <div>
        <input type="text" style={inputStyle} value={result} readOnly placeholder="Result" />
      </div>
      <div style={rowStyle}>
